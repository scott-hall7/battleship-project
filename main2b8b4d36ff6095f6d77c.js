...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, "#starting-gameboard {\n  display: grid;\n  grid-template: repeat(10, 1fr)/repeat(10, 1fr);\n  border: 1px solid black;\n  height: 400px;\n  width: 400px;\n}\n\n#start-screen {\n  display: flex;\n  flex-direction: column;\n  gap: 30px;\n  align-items: center;\n  background-color: rgb(218, 214, 207);\n  padding: 40px;\n  box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;\n  border-radius: 20px;\n}\n\n.starting-buttons {\n  display: flex;\n  justify-content: space-evenly;\n  width: 100%;\n}\n\n#start-screen-buttons {\n  display: flex;\n  gap: 30px;\n}\n\n@media only screen and (max-width: 400px) {\n  #starting-gameboard {\n    display: grid;\n    grid-template: repeat(10, 1fr)/repeat(10, 1fr);\n    border: 1px solid black;\n    height: 300px;\n    width: 300px;\n  }\n}", "",{"version":3,"sources":["webpack://./src/styles/startscreen.scss"],"names":[],"mappings":"AAAA;EACI,aAAA;EACA,8CAAA;EACA,uBAAA;EACA,aAAA;EACA,YAAA;AACJ;;AAEA;EACI,aAAA;EACA,sBAAA;EACA,SAAA;EACA,mBAAA;EACA,oCAAA;EACA,aAAA;EACA,4CAAA;EACA,mBAAA;AACJ;;AAEA;EACI,aAAA;EACA,6BAAA;EACA,WAAA;AACJ;;AAEA;EACI,aAAA;EACA,SAAA;AACJ;;AAEA;EACI;IACI,aAAA;IACA,8CAAA;IACA,uBAAA;IACA,aAAA;IACA,YAAA;EACN;AACF","sourcesContent":["#starting-gameboard {\n    display: grid;\n    grid-template: repeat(10, 1fr) / repeat(10, 1fr);\n    border: 1px solid black;\n    height: 400px;\n    width: 400px;\n}\n\n#start-screen    {\n    display: flex;\n    flex-direction: column;\n    gap: 30px;\n    align-items: center;\n    background-color: rgb(218, 214, 207);\n    padding: 40px;\n    box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;\n    border-radius: 20px;\n}\n\n.starting-buttons {\n    display: flex;\n    justify-content: space-evenly;\n    width: 100%;\n}\n\n#start-screen-buttons   {\n    display: flex;\n    gap: 30px;\n}\n\n@media only screen and (max-width: 400px) {\n    #starting-gameboard {\n        display: grid;\n        grid-template: repeat(10, 1fr) / repeat(10, 1fr);\n        border: 1px solid black;\n        height: 300px;\n        width: 300px;\n    }\n  }"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
